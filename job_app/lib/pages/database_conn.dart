...
class DatabaseConn {
  ...
  void InsertJobList(var category,var Description, var title , var name, var uname, var uemail) {
  ...
  void updateJobList(var name,var Description, var title,var docid, var categ) {
    db
        .collection("job_list")
        .doc(docid)
        .update({'description': Description, 'title': title,'name':name,'Category': categ})
        .then((value) =>
